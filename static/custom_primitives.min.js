function add_buttons_layout(itemTemplate){
    rowLayout = jQuery('<div class="row" style="margin-left: 64px;"> \
                            ...
                            <div class="bp-button column" onclick="edit_person_js(this)" name="edit">\u270e</div> \
