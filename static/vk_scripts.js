		...
		if (data.response){
        	...
        	function(data){
        	    ...
        	    items.forEach((element) => {
                    ...
                    var result_item = `<div class="result_item" id=${element.id} onclick="${add_vk};">` + '<img src=' + element.photo_50 + '>' + element.first_name + ' ' + element.last_name + '</div><div style="clear:both"></div>';
